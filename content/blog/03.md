...
I decided to set up dynamic DNS for my website (see [remarks](#remarks)). As much of a potential help to you as to my future self, I will be demonstrating in this article how to set up DDNS for Cloudflare using `ddclient`.
