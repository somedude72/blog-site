...
$ sudo ddclient -daemon=0 -verbose  # Connects to the Cloudflare DNS API
```

When both of these commands run succesfully, restart the daemon and you're all set!
