...
There are many other advanced techniques that one is able to use to make the LLMs sound more natural, give more accurate information, or specialize in niche areas. However, due to the length of the article, I will not go over them here. I hope that after reading this article, you will no longer think of AI as a magical black box, and I hope you now understand how LLMs function at a deeper level. In doing so, I also hope you will now use AI more responsibly and cautiously. 

In a later article (which I may or may not have time to write), I will discuss the ethical implications of deploying powerful AI models, and how inter-human communications might be affected by them. In the mean time, I'll finish this article with a quote that has basically become cliché at this point, and a quote that I hope you have a better understanding of now even though I didn't go over any math — "AI isn't magic, it's math".
